...
public class ClanokObj {
     ...
     * @param creator
     */
    public ClanokObj(String title, String link, String description, Date pubDate, Image enclosure, String creator) {
        this.title = title;
        this.link = link;
     ...
     * @param text
     */
    public ClanokObj(String title, String link, String description, Date pubDate, Image enclosure, String creator, int id, String type, String text) {
        this.title = title;
        this.link = link;
        this.description = description;
        this.pubDate = pubDate;
