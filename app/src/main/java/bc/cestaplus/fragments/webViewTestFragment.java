 ...
 * Use the {@link webViewTestFragment#newInstance} factory method to
...
public class webViewTestFragment extends Fragment {
     ...
     *
     * @return A new instance of fragment webViewTestFragment.
     */
    public static webViewTestFragment newInstance() {
        webViewTestFragment fragment = new webViewTestFragment();
        Bundle args = new Bundle();
        fragment.setArguments(args);
        return fragment;
    }

    public webViewTestFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_web_view_test, container, false);
        ...
        */
        ...
        //mWebView.loadUrl("http://www.cestaplus.sk/");
        ...
        WebSettings webSettings = mWebView.getSettings();
        //webSettings.setLoadsImagesAutomatically(true); // zatial obrazky funguju aj bez toho
