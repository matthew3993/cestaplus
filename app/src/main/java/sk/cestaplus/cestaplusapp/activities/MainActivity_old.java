...
public class MainActivity_old
 ...
 // job constants
    private static final int UPDATE_JOB_ID = 55;   //ľubovoľne zvolená hodnota, ale stale tá istá pre update job
...
// session
    ...
    //kontrola módu aplikácie
        ...
        MainActivity_old.context = getApplicationContext(); //getBaseContext();
    ...
    public static Context getAPPContext() {
        ...
        return MainActivity_old.context;
    }
    ...
    public void onNewIntent(Intent intent) {
        ...
        if (intent.getBooleanExtra("fromNotification", false)) {
            ...
            Intent i = new Intent(this, MainActivity_old.class);
